...
import com.bob1.app.data.dto.ConfirmEmailRequest
import com.bob1.app.data.dto.ForgotPasswordRequest
import com.bob1.app.data.dto.LoginRequest
import com.bob1.app.data.dto.MessageResponse
import com.bob1.app.data.dto.RefreshTokenRequest
import com.bob1.app.data.dto.RegisterRequest
import com.bob1.app.data.dto.ResetPasswordRequest
...
/**
 * Passerelle vers les endpoints d'authentification de l'API bob1 (`/auth/`).
 *
 * L'authentification est basée sur des cookies HTTP (`bob1_token`, `bob1_refresh_token`)
